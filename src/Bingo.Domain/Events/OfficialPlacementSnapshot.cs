...
public sealed class OfficialPlacementSnapshot
{
    ...
    public Guid Id{get;private set;} public Guid FinalizationId{get;private set;} public Guid EventId{get;private set;} public Guid TeamId{get;private set;} public string TeamName{get;private set;}=string.Empty; public int Placement{get;private set;} public bool BoardComplete{get;private set;} public DateTimeOffset?BoardCompletedAt{get;private set;} public int CompletedLines{get;private set;} public int CompletedTiles{get;private set;} public decimal EhbTiebreak{get;private set;}
}
