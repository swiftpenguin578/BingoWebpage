...
public sealed class FinalReviewResolution
{
    ...
    public string BlockerKey { get; private set; } = string.Empty; public string BlockerDescription { get; private set; } = string.Empty; public string Reason { get; private set; } = string.Empty; public Guid ResolvedByAccountId { get; private set; }
