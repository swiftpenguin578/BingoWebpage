...
{
    private BoardTile() { }
    public BoardTile(Guid id, Guid boardId, Guid tileTemplateId, int row, int column, string name, string description, string evidenceInstructions, decimal estimatedEhb)
    { Id = id; BoardId = boardId; TileTemplateId = tileTemplateId; RowIndex = row; ColumnIndex = column; NameSnapshot = name; DescriptionSnapshot = description; EvidenceInstructionsSnapshot = evidenceInstructions; EstimatedEhbSnapshot = estimatedEhb; }
    ...
    public void UpdateContent(string name, string description, string evidenceInstructions, decimal estimatedEhb)
    {
        NameSnapshot = name;
