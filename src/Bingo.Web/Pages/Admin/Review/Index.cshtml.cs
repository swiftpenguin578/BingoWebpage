...
public sealed class IndexModel(ApplicationDbContext db) : PageModel
{
    ...
    public IReadOnlyList<TeamOption> Teams { get; private set; } = []; public IReadOnlyList<TileOption> Tiles { get; private set; } = []; public IReadOnlyList<Row> Rows { get; private set; } = [];
