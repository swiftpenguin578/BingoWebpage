...
Signup Questions, the canonical submission workspace, Admin evidence review, Finalize/Audit,
...
The user-approved Captain/participant submission-workspace consolidation is the
remaining Public/participant implementation family before final whole-application
regression: `/Submissions` and `/Submissions/{id}` are the sole canonical
