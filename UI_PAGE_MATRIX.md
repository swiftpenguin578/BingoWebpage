...
and committed on 2026-08-31; final whole-application regression remains. The
linked-resubmission Admin Review journey still needs manual confirmation, and no
query change is authorized without new evidence.
F-04 is resolved by the narrow Live display-timezone correction; the future F-06
