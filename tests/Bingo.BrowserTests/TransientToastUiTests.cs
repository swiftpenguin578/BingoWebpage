...
public sealed class TransientToastUiTests
{
    ...
    public void TransientToastKeepsTheSharedTypeAndPauseContract()
    {
        ...
        Assert.Contains("align-items: center;", toastStyles);
        Assert.Contains("min-height: 5.25rem;", toastStyles);
        Assert.Contains("padding: 1.125rem 1.25rem;", toastStyles);
        ...
        Assert.Contains("gap: 0.9rem", styles);
        Assert.Contains("width: 1.5rem", styles);
        Assert.Contains("height: 1.5rem", styles);
        Assert.Contains("flex: 0 0 1.5rem", styles);
        Assert.Contains("font-size: 0.8125rem", styles);
        Assert.Contains("font-size: 0.9375rem", styles);
        Assert.Contains("width: 2.75rem", styles);
        Assert.Contains("height: 2.75rem", styles);
