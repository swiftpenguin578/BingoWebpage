...
public sealed class Slice7Pass71IntegrationTests : IAsyncLifetime
{
    ...
    {
        public Task<Bingo.Application.Events.SignupLifecycleResult> SaveScheduleAsync(Guid eventId, long version, Bingo.Application.Events.EventScheduleValues values, bool acknowledgeScheduledWarnings, bool confirmPublicChange, string? reason, LifecycleActor actor, CancellationToken ct = default) => throw new NotSupportedException();
